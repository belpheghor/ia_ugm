...
class Major extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('admin/major/tampil', $data);
	...
	function add()
	{
		...
		if($inputan)
		{
			...
			// redirect tampilan admin/major/index
			redirect('admin/major','refresh');

		}
		$data['login'] = $this->session->userdata("admin");
		$data['faculty']=$this->Mfaculty->tampil_fakultas();
		$this->load->view('admin/header', $data); 
		$this->load->view('admin/major/tambah');
		$this->load->view('admin/footer'); 
	...
	function edit($id){
		...
		$data['faculty']=$this->Mfaculty->tampil_fakultas();
		$this->load->view('admin/header', $data);
		$this->load->view('admin/major/ubah', $data);
		$this->load->view('admin/footer');
	}
	function status($id)
	{
		$this->Mmajor->select_major($id);
		redirect('admin/major','refresh');
	}
