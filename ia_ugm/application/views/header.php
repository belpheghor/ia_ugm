...
<body>
    ...
    <div id="head-bg"></div>
    <section class="flex-column justify-content-between" id="hero" style="background-color:rgba(255,255,255,0);">
        <nav class="navbar navbar-light text-center navbar-expand-md navbar-float" data-aos="fade" id="navbar-home">
            <div class="container-fluid"><a class="navbar-brand" href="<?php echo base_url();?>" style="background-repeat:no-repeat;width:161;background-position:center;background-size:80%;"><img src="<?php echo base_url("assets/img/partner-logo/logo_ia.png") ?>" id="logo-brand"></a> <!-- <button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>  -->
                <div
                class="collapse navbar-collapse text-center" id="navcol-1">
                <ul class="nav navbar-nav ml-auto">
                    <li class="nav-item" role="presentation"><a class="nav-link active .navbar-menu" href="#">Program</a></li>
                ...
                <form class="form-inline ml-auto" target="_self" style="margin:0px;margin-left:0px;">
                    <div class="form-group col-md-offset-3"><label for="search-field"><i class="fa fa-search"></i></label><input class="form-control" type="search" name="search" id="search-tab"></div>
                </form>
            </div>
        </div>
    </nav>
    <h1 class="text-center" id="subtitle"><img src="assets/img/partner-logo/logo_ia.png" id="logo-main"></h1>
</section>