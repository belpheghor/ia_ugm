 			...
 			<?php foreach ($program as $key => $value): ?>
 				<tr>
 					...
 					<td>
 						...
 						<a href="<?php echo base_url("supervisor/program/edit/$value[program_id]") ?>" class="btn btn-info btn-sm"> Edit</a>

 						<a href="<?php echo base_url("supervisor/program/delete/$value[program_id]") ?>" class="btn btn-danger btn-sm">Delete</a>
 					</td> 
 				</tr>
