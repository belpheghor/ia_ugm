...
<form method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<textarea class="form-control" name="timeline_description"><?php echo $timeline['timeline_description'] ?></textarea>
	...
	<div class="form-group">
		...
		<img src="<?php echo base_url("assets/timeline/$timeline[timeline_image]") ?>">
	...
	<a href="<?php echo base_url("admin/timeline/"); ?>" class="btn btn-danger">Cancel</a>
