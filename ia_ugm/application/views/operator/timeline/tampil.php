 			...
 			<?php foreach ($timeline as $key => $value): ?>
 				<tr>
 					...
 					<td>
 						...
 						<a href="<?php echo base_url("admin/timeline/edit/$value[timeline_id]") ?>" class="btn btn-info btn-sm"> Edit</a>

 						<a href="<?php echo base_url("admin/timeline/delete/$value[timeline_id]") ?>" class="btn btn-danger btn-sm">Delete</a>
 					</td> 
 				</tr>
