...
<hr>
<a href="<?php echo base_url("operator/background/add") ?>" class="btn btn-success btn-sm">Create New</a> 
<br>
<br>
			...
			<tr>
				...
				<td>
 					...
 					<td>
 							...
 							<!-- <a href="<?php echo base_url("operator/background/edit/$value[background_id]") ?>"
 							class="btn btn-info btn-xs">Edit</a> -->
 							
 							<?php if ($value['permission_status']=="Accepted"): ?>
 							<a href="<?php echo base_url("operator/background/select/$value[background_id]") ?>" class="btn btn-default btn-xs">Select</a>
 							<a href="<?php echo base_url("operator/background/delete/$value[background_id]") ?>" class="btn btn-danger btn-xs">Delete</a>
 						...
 						<?php if ($value['permission_status']==""): ?>
 							...
 							<a href="<?php echo base_url("operator/background/status/$value[background_id]") ?>" class="btn btn-success btn-xs">Ask Permission</a>
 						<?php endif ?>
 					</td>
